...
`;class St{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Et=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends St{update(t,[e]){const i=t.element;return i._actionHandler?i._actionHandler.options=e:(i._actionHandler={options:e,held:!1},i.addEventListener("pointerdown",t=>{const e=i._actionHandler;e.held=!1,e.options.hasHold&&(e.timer=setTimeout(()=>{e.held=!0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"hold"},bubbles:!0,composed:!0}))},500))}),i.addEventListener("pointerup",()=>{const t=i._actionHandler;t.timer&&(clearTimeout(t.timer),t.timer=void 0),t.held||(t.options.hasDoubleClick?t.dblClickTimer?(clearTimeout(t.dblClickTimer),t.dblClickTimer=void 0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"double_tap"},bubbles:!0,composed:!0}))):t.dblClickTimer=setTimeout(()=>{t.dblClickTimer=void 0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"tap"},bubbles:!0,composed:!0}))},250):i.dispatchEvent(new CustomEvent("action",{detail:{action:"tap"},bubbles:!0,composed:!0})))}),i.addEventListener("pointercancel",()=>{const t=i._actionHandler;t.timer&&(clearTimeout(t.timer),t.timer=void 0)})),q}render(t){return q}});function Ct(t){return void 0!==t&&"none"!==t.action}var Pt,kt=function(t,e,i,o){var s,n=arguments.length,r=n<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,i,r):s(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};let Tt=class extends ct{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.color="",this._pressed=!1,this._localValue=null,this._activePointerId=null}static{Pt=this}static{this.styles=xt}updated(t){t.has("_pressed")&&(this._pressed?this.setAttribute("pressed",""):this.removeAttribute("pressed"))}get _displayValue(){return this._localValue??this.value}get _fillFraction(){return 1-(this._displayValue-this.min)/(this.max-this.min)}static{this.MIN_VISUAL_FILL=6}render(){const t=100*this._fillFraction,e=Pt.MIN_VISUAL_FILL,i=e+t/100*(100-e),o=this.color?`--slider-color: ${this.color}`:"";return B`
      <div class="container" style="${o}">
        ...
        >
          ...
          <div class="slider-track-fill" style="height: ${i}%"></div>
          <div class="slider-handle"
               style="top: max(10px, calc(${i}% - 26px))"></div>
        </div>
        <div class="tooltip"
             style="top: max(10px, calc(${i}% - 26px))">
          ${Math.round(this._displayValue)} %
        </div>
      </div>
    `}_computeValueFromEvent(t){const e=this.renderRoot.querySelector(".slider");if(!e)return this.value;const i=e.getBoundingClientRect(),o=(1-(t.clientY-i.top)/i.height)*(this.max-this.min)+this.min;return this._clampAndStep(o)}_clampAndStep(t){const e=Math.round(t/this.step)*this.step;return Math.max(this.min,Math.min(this.max,e))}_onPointerDown(t){this.disabled||(t.preventDefault(),t.currentTarget.setPointerCapture(t.pointerId),this._activePointerId=t.pointerId,this._pressed=!0,this._localValue=this._computeValueFromEvent(t),this._fireEvent("slider-moved",{value:this._localValue}))}_onPointerMove(t){this._pressed&&t.pointerId===this._activePointerId&&(t.preventDefault(),this._localValue=this._computeValueFromEvent(t),this._fireEvent("slider-moved",{value:this._localValue}))}_onPointerUp(t){if(!this._pressed||t.pointerId!==this._activePointerId)return;const e=this._localValue??this.value;this._pressed=!1,this._localValue=null,this._activePointerId=null,this._fireEvent("value-changed",{value:e})}_onKeyDown(t){if(this.disabled)return;let e=null;const i=this._displayValue;switch(t.key){case"ArrowUp":e=this._clampAndStep(i-this.step);break;case"ArrowDown":e=this._clampAndStep(i+this.step);break;case"PageUp":e=this._clampAndStep(i-10);break;case"PageDown":e=this._clampAndStep(i+10);break;case"Home":e=this.min;break;case"End":e=this.max;break;default:return}t.preventDefault(),null!==e&&this._fireEvent("value-changed",{value:e})}_fireEvent(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}};kt([ut({type:Number})],Tt.prototype,"value",void 0),kt([ut({type:Number})],Tt.prototype,"min",void 0),kt([ut({type:Number})],Tt.prototype,"max",void 0),kt([ut({type:Number})],Tt.prototype,"step",void 0),kt([ut({type:Boolean})],Tt.prototype,"disabled",void 0),kt([ut({type:String})],Tt.prototype,"color",void 0),kt([_t()],Tt.prototype,"_pressed",void 0),kt([_t()],Tt.prototype,"_localValue",void 0),Tt=Pt=kt([ht("vertical-cover-slider")],Tt);var Ot=function(t,e,i,o){var s,n=arguments.length,r=n<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,i,r):s(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};const Ut=["cover-open-close","cover-position","cover-tilt","cover-tilt-position"];let Mt=class extends ct{static{this.styles=n`
    .editor-section {
      margin-bottom: 16px;
    }
