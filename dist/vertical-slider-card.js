      ...
      <div class="container" style="${i}">
        ...
        >
          ...
          <div class="slider-handle"
               style="bottom: calc(${e}% + 24px)"></div>
        </div>
        <div class="tooltip"
             style="bottom: calc(${e}% + 18px)">
