...
`;class xt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const St=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends xt{update(t,[e]){const i=t.element;return i._actionHandler?i._actionHandler.options=e:(i._actionHandler={options:e,held:!1},i.addEventListener("pointerdown",t=>{const e=i._actionHandler;e.held=!1,e.options.hasHold&&(e.timer=setTimeout(()=>{e.held=!0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"hold"},bubbles:!0,composed:!0}))},500))}),i.addEventListener("pointerup",()=>{const t=i._actionHandler;t.timer&&(clearTimeout(t.timer),t.timer=void 0),t.held||(t.options.hasDoubleClick?t.dblClickTimer?(clearTimeout(t.dblClickTimer),t.dblClickTimer=void 0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"double_tap"},bubbles:!0,composed:!0}))):t.dblClickTimer=setTimeout(()=>{t.dblClickTimer=void 0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"tap"},bubbles:!0,composed:!0}))},250):i.dispatchEvent(new CustomEvent("action",{detail:{action:"tap"},bubbles:!0,composed:!0})))}),i.addEventListener("pointercancel",()=>{const t=i._actionHandler;t.timer&&(clearTimeout(t.timer),t.timer=void 0)})),W}render(t){return W}});function Ct(t){return void 0!==t&&"none"!==t.action}var Pt=function(t,e,i,s){var o,n=arguments.length,r=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(o=t[a])&&(r=(n<3?o(r):n>3?o(e,i,r):o(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};let kt=class extends ct{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.color="",this._pressed=!1,this._localValue=null,this._activePointerId=null}static{this.styles=Et}updated(t){t.has("_pressed")&&(this._pressed?this.setAttribute("pressed",""):this.removeAttribute("pressed"))}get _displayValue(){return this._localValue??this.value}get _fillFraction(){return 1-(this._displayValue-this.min)/(this.max-this.min)}render(){const t=100*this._fillFraction,e=100*(1-this._fillFraction),i=this.color?`--slider-color: ${this.color}`:"";return B`
      <div class="container" style="${i}">
        ...
        >
          ...
          <div class="slider-handle" style="bottom: ${e}%"></div>
        </div>
        <div class="tooltip" style="bottom: ${e}%">
  ...
  `}setConfig(t){this._config=t}render(){return this.hass&&this._config?B`
    ...
    `:q}_hasFeature(t){return this._config.features?.some(e=>e.type===t)??!1}_featureLabel(t){switch(t){case"cover-open-close":return this.hass.localize?.("ui.panel.lovelace.editor.features.types.cover-open-close.label")||"Open/Close";case"cover-position":return this.hass.localize?.("ui.panel.lovelace.editor.features.types.cover-position.label")||"Position";case"cover-tilt":return this.hass.localize?.("ui.panel.lovelace.editor.features.types.cover-tilt.label")||"Tilt";case"cover-tilt-position":return this.hass.localize?.("ui.panel.lovelace.editor.features.types.cover-tilt-position.label")||"Tilt position";default:return t}}_entityChanged(t){const e=t.detail.value;e&&this._updateConfig({entity:e})}_nameChanged(t){const e=t.target;this._updateConfig({name:e.value||void 0})}_iconChanged(t){this._updateConfig({icon:t.detail.value||void 0})}_hideStateChanged(t){const e=t.target;this._updateConfig({hide_state:e.checked||void 0})}_featureToggled(t,e){const i=t.target.checked,s=[...this._config.features||[]];if(i)s.push({type:e});else{const t=s.findIndex(t=>t.type===e);t>=0&&s.splice(t,1)}this._updateConfig({features:s})}_updateConfig(t){this._config={...this._config,...t},gt(this,"config-changed",{config:this._config})}};Tt([ut({attribute:!1})],Ut.prototype,"hass",void 0),Tt([_t()],Ut.prototype,"_config",void 0),Ut=Tt([ht(At)],Ut);var Mt=function(t,e,i,s){var o,n=arguments.length,r=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(o=t[a])&&(r=(n<3?o(r):n>3?o(e,i,r):o(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};console.info("%c VERTICAL-SLIDER-CARD %c v1.0.0 ","color: white; background: #7c4dff; font-weight: 700;","color: #7c4dff; background: white; font-weight: 700;");let Ht=class extends ct{static{this.styles=wt}static getConfigElement(){return document.createElement(At)}static getStubConfig(t){return{entity:Object.keys(t.states).find(t=>t.startsWith("cover."))||"cover.example",features:[{type:"cover-open-close"}]}}setConfig(t){if(!t.entity||!t.entity.startsWith("cover."))throw new Error("Please define a cover entity");this._config={tap_action:{action:"more-info"},hold_action:{action:"none"},double_tap_action:{action:"none"},icon_tap_action:{action:"more-info"},...t}}getCardSize(){return 4}shouldUpdate(t){if(t.has("_config"))return!0;if(!t.has("hass"))return!1;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]}render(){if(!this.hass||!this._config)return q;const t=this.hass.states[this._config.entity];if(!t)return B`
        <ha-card>
          <div class="info">
            <div class="state-text">Entity not found: ${this._config.entity}</div>
          </div>
        </ha-card>
      `;const e="unavailable"===t.state||"unknown"===t.state,i=t.attributes.current_position??0,s=(this._config.name||t.attributes.friendly_name,this._computeStateDisplay(t)),o=this._computeLastChanged(t),n=this._computeColor(),r=t.attributes.supported_features??0;return e?this.setAttribute("unavailable",""):this.removeAttribute("unavailable"),B`
      <ha-card
      ...
      >
        <div class="info">
          ...
          ${o?B`<div class="last-changed">${o}</div>`:q}
        </div>
