...
`;class St{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Et=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends St{update(t,[e]){const i=t.element;return i._actionHandler?i._actionHandler.options=e:(i._actionHandler={options:e,held:!1},i.addEventListener("pointerdown",t=>{const e=i._actionHandler;e.held=!1,e.options.hasHold&&(e.timer=setTimeout(()=>{e.held=!0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"hold"},bubbles:!0,composed:!0}))},500))}),i.addEventListener("pointerup",()=>{const t=i._actionHandler;t.timer&&(clearTimeout(t.timer),t.timer=void 0),t.held||(t.options.hasDoubleClick?t.dblClickTimer?(clearTimeout(t.dblClickTimer),t.dblClickTimer=void 0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"double_tap"},bubbles:!0,composed:!0}))):t.dblClickTimer=setTimeout(()=>{t.dblClickTimer=void 0,i.dispatchEvent(new CustomEvent("action",{detail:{action:"tap"},bubbles:!0,composed:!0}))},250):i.dispatchEvent(new CustomEvent("action",{detail:{action:"tap"},bubbles:!0,composed:!0})))}),i.addEventListener("pointercancel",()=>{const t=i._actionHandler;t.timer&&(clearTimeout(t.timer),t.timer=void 0)})),q}render(t){return q}});function Ct(t){return void 0!==t&&"none"!==t.action}var kt=function(t,e,i,o){var s,n=arguments.length,r=n<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,i,r):s(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};let Pt=class extends ct{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.color="",this._pressed=!1,this._localValue=null,this._tooltipSide="left",this._activePointerId=null}static{this.styles=At}updated(t){t.has("_pressed")&&(this._pressed?this.setAttribute("pressed",""):this.removeAttribute("pressed"))}get _displayValue(){return this._localValue??this.value}get _fillFraction(){return 1-(this._displayValue-this.min)/(this.max-this.min)}render(){const t=100*this._fillFraction,e=this.color?`--slider-color: ${this.color}`:"",i=`calc(26px + ${t} * (100% - 26px) / 100)`,o=`calc(26px + ${t} * (100% - 26px) / 100 - 15px)`;return F`
    ...
    `}_computeValueFromEvent(t){const e=this.renderRoot.querySelector(".slider");if(!e)return this.value;const i=e.getBoundingClientRect(),o=i.height-15-11,s=t.clientY-i.top-11,n=(1-Math.max(0,Math.min(1,s/o)))*(this.max-this.min)+this.min;return this._clampAndStep(n)}_clampAndStep(t){const e=Math.round(t/this.step)*this.step;return Math.max(this.min,Math.min(this.max,e))}_onPointerDown(t){if(this.disabled)return;t.preventDefault(),t.currentTarget.setPointerCapture(t.pointerId),this._activePointerId=t.pointerId;const e=this.getBoundingClientRect(),i=this.parentElement||this.getRootNode()&&this.getRootNode().host?.parentElement,o=i?i.getBoundingClientRect():e,s=e.left-o.left,n=o.right-e.right;this._tooltipSide=s>=45||s>=n?"left":"right",this._pressed=!0,this._localValue=this._computeValueFromEvent(t),this._fireEvent("slider-moved",{value:this._localValue})}_onPointerMove(t){this._pressed&&t.pointerId===this._activePointerId&&(t.preventDefault(),this._localValue=this._computeValueFromEvent(t),this._fireEvent("slider-moved",{value:this._localValue}))}_onPointerUp(t){if(!this._pressed||t.pointerId!==this._activePointerId)return;const e=this._localValue??this.value;this._pressed=!1,this._localValue=null,this._activePointerId=null,this._fireEvent("value-changed",{value:e})}_onKeyDown(t){if(this.disabled)return;let e=null;const i=this._displayValue;switch(t.key){case"ArrowUp":e=this._clampAndStep(i-this.step);break;case"ArrowDown":e=this._clampAndStep(i+this.step);break;case"PageUp":e=this._clampAndStep(i-10);break;case"PageDown":e=this._clampAndStep(i+10);break;case"Home":e=this.min;break;case"End":e=this.max;break;default:return}t.preventDefault(),null!==e&&this._fireEvent("value-changed",{value:e})}_fireEvent(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}};kt([ut({type:Number})],Pt.prototype,"value",void 0),kt([ut({type:Number})],Pt.prototype,"min",void 0),kt([ut({type:Number})],Pt.prototype,"max",void 0),kt([ut({type:Number})],Pt.prototype,"step",void 0),kt([ut({type:Boolean})],Pt.prototype,"disabled",void 0),kt([ut({type:String})],Pt.prototype,"color",void 0),kt([_t()],Pt.prototype,"_pressed",void 0),kt([_t()],Pt.prototype,"_localValue",void 0),kt([_t()],Pt.prototype,"_tooltipSide",void 0),Pt=kt([ht("vertical-cover-slider")],Pt);var Tt=function(t,e,i,o){var s,n=arguments.length,r=n<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,i,r):s(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};const Ot=["cover-open-close","cover-position"];let Ut=class extends ct{static{this.styles=n`
    .editor-section {
      margin-bottom: 16px;
    }
